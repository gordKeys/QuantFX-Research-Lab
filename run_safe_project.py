...
def main():
    parser = argparse.ArgumentParser(description="Safe winners launcher")
    parser.add_argument("mode", choices=["test", "walkforward", "milestone", "tournament"], help="Choose what to run")
    ...
    return run_script("safe_winner_experiment.py", [args.mode, *forwarded])
