...
def main():
    parser = argparse.ArgumentParser(description="Focused combo + walkforward with FTMO drawdown comparison")
    ...
    with timed("focused_combo_report", style="days"):
        print("\n=== FOCUSED COMBO + WALK-FORWARD ===")
        print(
        ...
        for symbol in symbols:
            ...
            if strategy_name is None:
                print(f"{symbol:>10} | {'unsupported':>24} | {'n/a':>10} | {'n/a':>9} | {'n/a':>15} | {'n/a':>10} | {'n/a':>9} | {'n/a':>15} | {'n/a':>8} | {'n/a':>8}")
                continue
